<?php
/**
 * My Reports - Student/Faculty/Staff
 */
$auth = new Auth();
$func = new Functions();
...
<div class="container py-4">
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                ...
                <p class="page-subtitle text-muted">Track all facility reports you have submitted.</p>
            </div>
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-body">
            <form method="GET" action="/my-reports" class="row g-3 align-items-end">
                <div class="col-md-4">
                ...
                <div class="col-md-5">
                    ...
                    <div class="search-box">
                        ...
                        <input type="search" name="search" class="form-control"
                               placeholder="Search by report number, title, or description..."
    ...
    <?php else: ?>
        <div class="card shadow-sm border-0">
            ...
            <div class="card-footer bg-light border-0">
                <small class="text-muted">Showing <?php echo count($reports); ?> of <?php echo $totalReports; ?> reports</small>
            </div>
        </div>
    <?php endif; ?>
</div>
